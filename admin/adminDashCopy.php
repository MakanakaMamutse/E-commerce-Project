            ...
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="account.html"><i class="fas fa-user me-2"></i>Profile</a></li>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-0">$<?php echo $total_revenue ?></h3>
                                </div>
                                <div class="align-self-center">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>placeholder</td>
                                    <td>irrelevant</td>
                                    <td><span class="badge bg-info">visual</span></td>
                                    <td>layout</td>
                                </tr>
                                <tr>
                                    <td>1,003</td>
                                    <td>data</td>
                                    <td>rich</td>
                                    <td><span class="badge bg-primary">dashboard</span></td>
                                    <td>tabular</td>
                                </tr>
                                <tr>
                                    <td>1,003</td>
                                    <td>information</td>
                                    <td>placeholder</td>
                                    <td><span class="badge bg-warning">illustrative</span></td>
                                    <td>data</td>
                                </tr>
                                <tr>
                                    <td>1,004</td>
                                    <td>text</td>
                                    <td>random</td>
                                    <td><span class="badge bg-success">layout</span></td>
                                    <td>dashboard</td>
                                </tr>
                                <tr>
                                    <td>1,005</td>
                                    <td>dashboard</td>
                                    <td>irrelevant</td>
                                    <td><span class="badge bg-danger">text</span></td>
                                    <td>placeholder</td>
                                </tr>
                                <tr>
                                    <td>1,006</td>
                                    <td>dashboard</td>
                                    <td>illustrative</td>
                                    <td><span class="badge bg-dark">rich</span></td>
                                    <td>data</td>
                                </tr>
                                <tr>
                                    <td>1,007</td>
                                    <td>placeholder</td>
                                    <td>tabular</td>
                                    <td><span class="badge bg-light text-dark">information</span></td>
                                    <td>irrelevant</td>
                                </tr>
                                <tr>
                                    <td>1,008</td>
...
<?php
    ...
    if($_SESSION['role_type'] == 'admin') {
        ...
        // Prepare SQL statement to fetch user orders with pagination
        $orderQuery = "SELECT * FROM orders ORDER BY order_date DESC LIMIT ? OFFSET ?";
        $stmt = $conn->prepare($orderQuery);
        ...
        // Count total orders for this seller for pagination
        $count_query = "SELECT COUNT(*) as total FROM orders WHERE seller_id = ?";
        $count_stmt = $conn->prepare($count_query);
        ...
        // Prepare SQL statement to fetch user orders with pagination
        $orderQuery = "SELECT * FROM orders WHERE seller_id = ? ORDER BY order_date DESC LIMIT ? OFFSET ?";
        $stmt = $conn->prepare($orderQuery);
        ...
        if ($stmt) {
            // Bind parameters and execute query
            $stmt->bind_param("iii", $seller_id, $items_per_page, $offset);
            $stmt->execute();
            ...
            <div class="card">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">
                        Showing <?php echo min($offset + 1, $total_records); ?>-<?php echo min($offset + $items_per_page, $total_records); ?> of <?php echo $total_records; ?> orders
                    </small>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
